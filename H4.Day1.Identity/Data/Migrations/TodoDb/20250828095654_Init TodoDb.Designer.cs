...
namespace H4.Day1.Identity.Data.Migrations.TodoDb
{
    ...
    [Migration("20250828095654_Init TodoDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("H4.Day1.Identity.Models.Cpr", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("H4.Day1.Identity.Models.Todolist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("H4.Day1.Identity.Models.Todolist", b =>
                {
                    b.HasOne("H4.Day1.Identity.Models.Cpr", "User")
                        .WithMany("Todolists")
